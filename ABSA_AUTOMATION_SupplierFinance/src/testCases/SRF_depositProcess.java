...
public class SRF_depositProcess {
	...
	public static void ProcessDeosits(String TestName) throws Exception {
		...
		try{ 	
			//Clean DB
		      ...
		      int k= Functions.SRF_GetSupplierException();
		      
		      if(k>0)
		      
		      {
		    	  
		    	  Functions.SRF_FixSupplierValidation();
	     ...
	     Functions.PutDepositFilesInServer();
